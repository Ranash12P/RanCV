...
const Projects = () => (
  <section className={styles.projects}>
    <div className={styles.container}>
      ...
      <a href="" target="_blank" rel="noopener noreferrer" className={styles.projectLink}>
        <div className={styles.project}>
          ...
          <p>Developed a full-stack application for managing a drinking system. Multi-stage software project, utilizing Java, Scene Builder, and Jubula. 
             Hands-on experience in full-stack system development and collaborative team settings.</p>
        </div>
      </a>

      {/* Online Book Club */}
      <a href="https://bookclubclient.vercel.app" target="_blank" rel="noopener noreferrer" className={styles.projectLink}>
        <div className={styles.project}>
      ...
      <a href="https://ranash12p.github.io/crypto-demo-ran" target="_blank" rel="noopener noreferrer" className={styles.projectLink}>
        <div className={styles.project}>
      ...
      <a href="https://ranash12p.github.io/RanResume" target="_blank" rel="noopener noreferrer" className={styles.projectLink}>
        <div className={styles.project}>
